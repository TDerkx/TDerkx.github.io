                ...
                //Huis_stad (rest leeg)
								...
								//Hui3_stad + Huis_type + Huis_prijs (type leeg)
								$res13 = mysql_query("SELECT * FROM verhuur WHERE Huis_stad = '$hs' AND Huis_prijs >= '$hpr2' AND Huis_prijs <= '$hpr1'",$mysql) or die("De query12 op de database is mislukt!");
								//Huis_type + Huis_type + Huis_pers (stad leeg)
								$res14 = mysql_query("SELECT * FROM verhuur WHERE Huis_type = '$ht' AND Huis_pers <= '$hpe1'",$mysql) or die("De query13 op de database is mislukt!");
					    	//Huis_stad + Huis_type + Huis_pers + Huis_prijs
								...
								elseif ($hs = 'No1' AND $ht = 'No2' AND $hpe1 = $_POST["Huis_pers"] AND $hpr1 = $_POST["Huis_prijs1"] AND $hpr2 = $_POST["Huis_prijs2"])
								{
								print("$res10");
								}
								...
								elseif ($hs = $_POST["Huis_stad"] AND $ht = 'No2' AND $hpe1 = $_POST["Huis_pers"] AND $hpr1 = $_POST["Huis_prijs1"] AND $hpr2 = $_POST["Huis_prijs2"])
								{
								print("$res13");
								}
								elseif ($hs = 'No1' AND $ht = $_POST["Huis_type"] AND $hpe1 = $_POST["Huis_pers"] AND $hpr1 = $_POST["Huis_prijs1"] AND $hpr2 = $_POST["Huis_prijs2"])
								{
								print("$res14");
								}
               
							  elseif ($hs = $_POST["Huis_stad"] AND $ht = $_POST["Huis_type"] AND $hpe1 = $_POST["Huis_pers"] AND $hpr1 = $_POST["Huis_prijs1"] AND $hpr2 = $_POST["Huis_prijs2"])
								{
								print("$res15");
								} 
								else
